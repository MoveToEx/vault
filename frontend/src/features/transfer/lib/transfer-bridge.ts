...
import {
  ...
  transferResumed,
  transferStarted,
} from "@/shared/stores/transfer";
import { mutate } from "@/shared/lib/swr";
import { formatError } from "@/shared/lib/utils";
import { transferRpcHandlers } from "@/features/transfer/lib/transfer-rpc";
...
class TransferBridge {
  ...
  constructor() {
    this.worker = new Worker(
      new URL("@/features/transfer/workers/transfer.worker.ts", import.meta.url),
      { type: "module" },
    );
